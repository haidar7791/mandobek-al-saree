...
const styles = StyleSheet.create({
  ...
  back: { width: 38, height: 38, borderRadius: 10, backgroundColor: "rgba(255,255,255,.12)", alignItems: "center", justifyContent: "center" }, headerTitle: { color: "#FFF", fontFamily: "Cairo_700Bold", fontSize: 17 },
  ...
  nameRow: { marginTop: 10, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, groupName: { color: C.text, fontFamily: "Cairo_700Bold", fontSize: 21, textAlign: "center", maxWidth: "82%" }, editName: { padding: 5 }, pencil: { fontSize: 19 }, count: { color: C.textMuted, fontFamily: "Cairo_400Regular", textAlign: "center", marginTop: 2, marginBottom: 18 },
  options: { gap: 10 }, option: { flexDirection: "row", alignItems: "center", gap: 11, backgroundColor: C.card, borderRadius: 15, padding: 13, borderWidth: 1, borderColor: C.border }, optionIcon: { width: 42, height: 42, borderRadius: 12, backgroundColor: "rgba(201,168,76,.12)", alignItems: "center", justifyContent: "center" }, optionText: { flex: 1 }, optionTitle: { color: C.text, fontFamily: "Cairo_700Bold", fontSize: 15, textAlign: "right" }, optionSub: { color: C.textMuted, fontFamily: "Cairo_400Regular", fontSize: 11, textAlign: "right", marginTop: 2 }, leaveOption: { marginTop: 5 }, leaveIcon: { backgroundColor: "rgba(239,68,68,.09)" },
  backdrop: { flex: 1, backgroundColor: "rgba(0,0,0,.6)", alignItems: "center", justifyContent: "center", padding: 20 }, renameBox: { width: "100%", maxWidth: 430, backgroundColor: C.background, borderRadius: 18, padding: 16 }, modalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, modalTitle: { color: C.text, fontFamily: "Cairo_700Bold", fontSize: 17 }, input: { backgroundColor: C.card, borderRadius: 12, minHeight: 48, paddingHorizontal: 12, color: C.text, fontFamily: "Cairo_400Regular", borderWidth: 1, borderColor: C.border }, save: { marginTop: 12, minHeight: 46, borderRadius: 12, backgroundColor: C.primary, alignItems: "center", justifyContent: "center" }, saveText: { color: "#FFF", fontFamily: "Cairo_700Bold" },
});
