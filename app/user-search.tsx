...
const styles = StyleSheet.create({
  ...
  initial: { fontSize: 21, fontFamily: undefined, color: C.accent },
  info: { flex: 1, gap: 3 },
  name: { fontSize: 15, fontFamily: undefined, color: C.text, textAlign: "right" },
  roleRow: { flexDirection: "row", justifyContent: "flex-end", alignItems: "center", gap: 5 },
  role: { fontSize: 12, fontFamily: undefined, color: C.textMuted },
