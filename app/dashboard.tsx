...
const styles = StyleSheet.create({
  ...
  commentComposer: { position: "absolute", left: 0, right: 0, bottom: 22, flexDirection: "row-reverse", alignItems: "center", gap: 8, borderTopWidth: 1, borderTopColor: C.border, backgroundColor: C.card, paddingTop: 10, paddingHorizontal: 14, paddingBottom: 0, marginTop: 0, marginBottom: 0 },
