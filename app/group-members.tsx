...
const styles=StyleSheet.create({root:{flex:1,backgroundColor:C.background},center:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:C.background},header:{backgroundColor:"#0D1B3E",flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingHorizontal:14,paddingBottom:14},back:{width:38,height:38,borderRadius:10,backgroundColor:"rgba(255,255,255,.12)",alignItems:"center",justifyContent:"center"},headerTitle:{color:"#FFF",fontFamily:"Cairo_700Bold",fontSize:17},addTop:{width:38,height:38,borderRadius:10,backgroundColor:"rgba(201,168,76,.14)",alignItems:"center",justifyContent:"center"},count:{color:C.textMuted,fontFamily:"Cairo_400Regular",textAlign:"right",marginBottom:9},row:{flexDirection:"row",alignItems:"center",gap:11,backgroundColor:C.card,borderRadius:14,padding:11,marginBottom:8,borderWidth:1,borderColor:C.border},avatar:{width:48,height:48,borderRadius:24},fallback:{width:48,height:48,borderRadius:24,backgroundColor:"rgba(201,168,76,.14)",alignItems:"center",justifyContent:"center"},initial:{color:C.accent,fontFamily:"Cairo_700Bold",fontSize:18},info:{flex:1},name:{color:C.text,fontFamily:"Cairo_700Bold",fontSize:15,textAlign:"right"},role:{color:C.textMuted,fontFamily:"Cairo_400Regular",fontSize:11,textAlign:"right",marginTop:2},backdrop:{flex:1,backgroundColor:"rgba(0,0,0,.6)",justifyContent:"flex-end"},modal:{backgroundColor:C.background,borderTopLeftRadius:20,borderTopRightRadius:20,padding:16,minHeight:"55%"},modalHead:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginBottom:12},modalTitle:{color:C.text,fontFamily:"Cairo_700Bold",fontSize:17},input:{backgroundColor:C.card,color:C.text,borderRadius:12,minHeight:46,paddingHorizontal:12,fontFamily:"Cairo_400Regular",borderWidth:1,borderColor:C.border,marginBottom:10},result:{flexDirection:"row",alignItems:"center",gap:10,backgroundColor:C.card,borderRadius:12,padding:9,marginBottom:7},resultAvatar:{width:42,height:42,borderRadius:21},resultFallback:{width:42,height:42,borderRadius:21,backgroundColor:"rgba(201,168,76,.14)",alignItems:"center",justifyContent:"center"},resultName:{flex:1,color:C.text,fontFamily:"Cairo_700Bold",textAlign:"right"},empty:{color:C.textMuted,fontFamily:"Cairo_400Regular",textAlign:"center",padding:20}}
);
