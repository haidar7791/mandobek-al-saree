...
const styles = StyleSheet.create({
  ...
  chatInitial: { fontSize: 15, fontFamily: undefined, color: C.accent },
  recipientMeta: { flex: 1, alignItems: "flex-end" },
  chatName: { fontSize: 14, fontFamily: undefined, color: C.text, textAlign: "right" },
  roleLabel: { fontSize: 10, fontFamily: undefined, color: C.textMuted, textAlign: "right", marginTop: 1 },
});
