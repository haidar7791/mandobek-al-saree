...
const styles = StyleSheet.create({
  ...
  name: { flexShrink: 1, fontSize: 15, fontFamily: "Cairo_700Bold", color: C.text, textAlign: "right", paddingLeft: 0 },
  time: { fontSize: 11, fontFamily: "Cairo_400Regular", color: C.textMuted },
  ...
  createGroupText: { fontSize: 12, fontFamily: "Cairo_700Bold", color: C.primary },
  ...
  modalTitle: { fontSize: 18, fontFamily: "Cairo_700Bold", color: C.text },
  groupPhotoPicker: {
  ...
  photoHint: { fontSize: 10, fontFamily: "Cairo_400Regular", color: C.textMuted, marginTop: 2 },
  groupInput: {
    minHeight: 46, borderRadius: 13, backgroundColor: C.card, color: C.text,
    fontFamily: "Cairo_400Regular", fontSize: 14, paddingHorizontal: 13, marginBottom: 9,
  },
  ...
  selectedChipText: { fontSize: 11, fontFamily: "Cairo_400Regular", color: C.text },
  ...
  userResultName: { flex: 1, textAlign: "right", fontSize: 13, fontFamily: "Cairo_700Bold", color: C.text },
  noUsers: { textAlign: "center", color: C.textMuted, fontFamily: "Cairo_400Regular", padding: 15 },
  createGroupAction: {
    minHeight: 48, borderRadius: 14, backgroundColor: C.accent,
    alignItems: "center", justifyContent: "center", marginTop: 4,
  },
  createGroupActionText: { fontSize: 14, fontFamily: "Cairo_700Bold", color: C.primary },
